...
<div id="searchDiv">
  ...
  <fieldset>
  <legend><?php echo T("Find Member by QR Code"); ?></legend>
  <table>
    <tr>
      <td nowrap="true">
        <label for="searchByBarcd"><?php echo T("Student/Faculty ID Number");?>:</label>
        <!-- QR code (student/faculty ID) lookup; accepts alphanumeric input --F. -->
        <input type="text" id="searchByBarcd" name="searchByBarcd" size="20" maxlength="50" />
...
<div id="mbrDiv">
  ...
  <fieldset id="identity">
    ...
    <label for="mbrQrcode"><?php echo T("Student/Faculty ID");?>:</label>
    <input type="text" readonly id="mbrQrcode" />
    <br />
  ...
  <tr>
    <td colspan="3">
      <fieldset>
        ...
        <thead>
        <tr>
          <th><?php echo T("Card Number");?></th>
          <th><?php echo T("Student/Faculty ID");?></th>
          <th><?php echo T("Name");?></th>
          <th><?php echo T("HomePhone");?></th>
          <th><?php echo T("MemberType");?></th>
        </tr>
        </thead>
