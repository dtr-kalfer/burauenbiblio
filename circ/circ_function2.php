...
function getDataJSON(PDO $pdo, string $startMonth, string $endMonth): string {
    $start = new DateTime($startMonth);
    $end = new DateTime($endMonth);

    // Normalize start to first day of month and end to the first of the next month
    $start->modify('first day of this month');
