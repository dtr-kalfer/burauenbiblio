 ...
 *
 * Refactored for PHP 8.3 — single-site deployment.
 * "Add New" and "Merge Sites" have been removed; sites are managed via Update only.
 */
...
<div id="listDiv" style="display: none;">
  ...
  <table id="showList" name="showList">
    ...
    <tfoot>
      <tr>
        <!-- spacer used to slightly separate button from form body -->
  ...
  <fieldset>
    ...
    <ul id="editTbl">
      ...
      <li>
        ...
        <input id="code" name="code" class="addOnly" type="text" size="32" maxlength="20" required aria-required="true" readonly />
        <span class="reqd">*</span>
      </li>
      <li>
