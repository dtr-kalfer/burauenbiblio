  ...
  switch ($_POST['mode']){
    ...
    case 'addNew_copyFlds':
      ...
      if ($errs) {
          ...
          echo json_encode(T("Add New successful"));
      }
      break;
    ...
    case 'addNew_mbrFlds':
      ...
      if ($errs) {echo json_encode(['error' => $errs]);} else {echo json_encode(T("Add New successful"));}
      break;
    case 'update_mbrFlds':
      $errs = $ptr->update_el(array(
        'code'=>@$_POST["code"],
    ...
    case 'd-3-L-3-t_media':
      $code = $_POST["code"];
      $description = $_POST["description"] ?? $_POST["desc"] ?? '';
      $ptr->deleteOne($code);
      $msg = T("Media Type")." '".H($description)."' ".T("has been deleted");
      echo json_encode($msg);
      break;
